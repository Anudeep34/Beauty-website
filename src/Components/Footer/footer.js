      ...
      <div id="foooter-bottom">
        ...
        <hr className="seprator_line"></hr>
            <h3 className="footer_heading">International</h3>
                <a href="" class="bottom-display-points-link">
                    <div class="bottom-display-points-right">xxxxxxx</div>
                </a>
                <a href="" class="bottom-display-points-link">
                    <div class="bottom-display-points-right">xxxx</div>
                </a>
                <a href="" class="bottom-display-points-link">
                    <div class="bottom-display-points-right">xxxxx</div>
                </a>
                <a href="" class="bottom-display-points-link">
                    <div class="bottom-display-points-right">xxxxxx</div>
                </a>
                <a href="" class="bottom-display-points-link">
                    <div class="bottom-display-points-right">xxxxxx</div>
                </a>
